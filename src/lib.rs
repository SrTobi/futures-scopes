...
//! 
//! - `local`: Enables [`LocalSpawnScope`](local::LocalSpawnScope).
...
/// Provides [`LocalSpawnScope`](local::LocalSpawnScope), which can spawn non-send/sync futures of non-static lifetime.
#[cfg(feature = "local")]
pub mod local;
